"""
Django settings for Pharmalife_Project project.
...
import os
SECRET_KEY = 'django-insecure-52zns!u8ch+%ywbp)^f0)xpprrgn-#2ypjvc11c9$(%f4n&qo9'
...
WSGI_APPLICATION = 'Pharmalife_Project.wsgi.application'
