...
const WeeklySales = () => {
  return (
    <div>
      <div className="h-48 w-full flex justify-between p-3">
        <div className="sales flex flex-col w-1/2 gap-2 items-center">
          <div className="bg-red-100 h-1/2 p-10 text-center">Total Orders</div>
          <div className="bg-green-200 h-1/2">200</div>
        </div>
