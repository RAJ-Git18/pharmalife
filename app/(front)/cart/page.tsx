...
const page = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-5 mb-10 w-full min-h-screen relative'>
      {cartItems.length > 0 ? (
        <>
          {cartItems.map((items) => (
            <div
          ...
          {/* Ok, Proceed Button */}
          <button
            className="sticky bottom-5 bg-blue-500 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-600 transition"
